...
.. location:: The Crimson Steps Temple
    :desc: Temple complex run by a bickering hierocracy
    :coords: 0.44596 0.21206
    :type: landmark
    :label_offset: below

    During the Years of Darkness, a particularly extreme sect of the Order of Scarlet vehemently believed the Silverblight to be a punishment sent by the Old Gods, and that it could only be abated by inflicting greater punishment on ourselves. Hence the red stains on the steps that lead up to the raised central courtyard that give the temple its name today.
...
.. location:: Worton
    :desc: Gnomish Village of herbalists
    :coords: 0.40108 0.19764
    :type: village
    :label_offset: below

    For generations the Gnomes of Worton have developed an expertise in local plants and herbs with medicinal and alchemical uses.

    The pungent ointments and salves created by the skilled village elders are thought to be a significant reason that the village has survived the encroaching Blightwood without a Blessed Defender to its name.


.. location:: Nim's Hollow
    :desc: Secluded Haven amidst the Blightwood
    :coords: 0.37537 0.19816
    :type: village
    :label_offset: left
...
.. location:: Grimstead-on-the-Lem
    :desc: Seat of the lost Duchy
    :coords: 0.39695 0.15803
    :type: village
    :label_offset: left

    What is now a crumbling ruin, overtaken by the crawling vines and twisted trees of the Blightwood, was once the seat of the Grand Duchy of Lem. This was during the Years of Darkness, at a time before the Blight had spread to the Valley proper and was still held back by the Grimpeaks.

    It was during the period of the Duchy of Lem that the Old Watchtower was constructed. Designed to provide vision of the nearby Blightwood, it was used to gain early warning and observation of advancing bands of blighted creatures.

    Even when it was known the fight was lost, the people struggled until the end until Blight consumed them all, including the last Duke and Duchess themselves.

    **Notable Residents:**

    * Duke Garrus III, Protector of the Valley


.. location:: Tarras
    :desc: Mountain retreat of the Ancient Erranites
    :coords: 0.39394 0.09949
    :type: ruin
    :label_offset: right
